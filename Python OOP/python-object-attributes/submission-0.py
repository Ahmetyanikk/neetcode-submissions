...
print("Initial Attributes: Whiskers (cat) - Hunger: "+str(whiskers.hunger)+", Energy: "+str(whiskers.energy))
...
print("Modified Attributes: Whiskers (cat) - Hunger: "+str(whiskers.hunger)+", Energy: "+str(whiskers.energy))
